...
<body>
    <div class="calculator">
        <form action="index.php" method="post">
            ...
            <div class="buttons">
                <button name="insert" value="1">1</button>
                <button name="insert" value="2">2</button>
                <button name="insert" value="3">3</button>
                <button name="insert" value="+">+</button>
                <button name="insert" value="4">4</button>
                <button name="insert" value="5">5</button>
                <button name="insert" value="6">6</button>
                <button name="insert" value="-">-</button>
                <button name="insert" value="7">7</button>
                <button name="insert" value="8">8</button>
                <button name="insert" value="9">9</button>
                <button name="insert" value="*">*</button>
                <button name="insert" value="0">0</button>
                <button name="insert" value=".">.</button>
                <button name="insert" value="/">/</button>
            </div>
